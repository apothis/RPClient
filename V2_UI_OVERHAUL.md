...
| 4.f | Header collapse | NEXT | After 4.g lands, fill chat header with title (editable) + `with <persona>` subhead + ⓘ inspector toggle + `…` chat-scoped overflow. Delete the empty 8pt strip. |
...
| 3 | Chat-pane implementation (§4.a-4.k) | IN PROGRESS — 4.a, 4.b.1, 4.b.2, 4.c, §D.11 detour, 4.d.1, 4.d.2, 4.e.1, 4.e.2, 4.e.3, 4.h.1, 4.j.1, 4.h.2, 4.g.1, 4.g.2, 4.g.3, 4.g.4 done. Remaining: 4.f, 4.i, 4.j.2, 4.k. | ~3 days remaining |
